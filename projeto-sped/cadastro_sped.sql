...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 24-Out-2025 às 20:03
...
--
-- Banco de dados: `cadastro_sped`
--
CREATE DATABASE IF NOT EXISTS `cadastro_sped` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE `cadastro_sped`;
...
CREATE TABLE IF NOT EXISTS `historico_buscas` (
  ...
  `termo_busca` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `produtos` (
  ...
  `preco` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
(4, '', 'gaybriel@gmail.com', '$2y$10$8xlwUPKQH1NFG7ffsIIfLuD6g80lgMVKV2vHabLtGzm9.fm6ezOi6', '2025-09-19 12:46:37', NULL),
(5, '', 'wina@gmail.com', '$2y$10$j882P4UzDWydYWtWaAS5KObliwX7yIeEREkjhCvLa3qYd1F9ChuV.', '2025-09-19 13:15:19', NULL),
(6, '', 'julinha@gmail.com', '$2y$10$DcUAW4UdeUXmoJdFNMPWXuDmGgvwI.6FcyKCdNKItRqWivTXpj9b2', '2025-09-19 13:16:56', NULL),
(7, '', 'julia@gmail.com', '$2y$10$45oMIeNq37oD70bukpSMXOZCBie9om6u5t/snCfWMMGBDcoid080S', '2025-09-19 13:23:02', NULL),
(8, '', 'gezota@gmail.com', '$2y$10$tPxdo81LfbZp89xmIDSyIO0ttUvDgdgBOexTrLWiMIEnkfSLAORf.', '2025-09-19 13:27:58', NULL),
(9, 'lelo', 'lelo@gmail.com', '$2y$10$mHfU2kP9w2q1ukH28VLuP.a5Z53VTEclDBBNtDQBKQXRR.2UTXd0S', '2025-09-19 13:34:54', NULL),
